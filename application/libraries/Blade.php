...
class Blade
{
    ...
    protected function _compile($template)
    {
        ...
        {
            // In production, avoid to admin if the template was updated
    ...
    /**
     * Rewrites Blade "@layouts" expressions into valid PHP.
     *
     * @param  string  $value
     * @return string
     */
    ...
    {
        $pattern = $this->matcher('layouts');

        // Find "@layouts" expressions
        if ( ! preg_match_all($pattern, $value, $matches, PREG_SET_ORDER))
        {
            return $value;
        }

        // Delete "@layouts" expressions
