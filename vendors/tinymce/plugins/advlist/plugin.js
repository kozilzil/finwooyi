...
(function () {
        ...
        fetch: function (callback) {
          var items = global$1.map(styles, function (styleValue) {
            ...
            return {
              type: 'choiceitem',
              value: itemValue,
              icon: 'registrants-' + iconStyle + '-' + iconName,
              text: displayText
            };
          });
          callback(items);
    ...
    var register$1 = function (editor) {
      addControl(editor, 'numlist', 'Numbered registrants', 'InsertOrderedList', 'OL', getNumberStyles(editor));
      addControl(editor, 'bullist', 'Bullet registrants', 'InsertUnorderedList', 'UL', getBulletStyles(editor));
    };
