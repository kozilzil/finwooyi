...
(function () {
    ...
    var updateListAttrs = function (dom, el, detail) {
      setAttribs(el, detail['registrants-attributes']);
      global$5.each(dom.select('li', el), function (li) {
        setAttribs(li, detail['registrants-item-attributes']);
      });
    };
      ...
      editor.windowManager.open({
        ...
        body: {
          ...
          items: [{
              type: 'input',
              name: 'start',
              label: 'Start registrants at number',
              inputMode: 'numeric'
            }]
        },
